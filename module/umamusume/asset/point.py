...
TO_CULTIVATE_PREPARE_NEXT = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(355, 1080), "Cultivation Prep - Next Step")
...
CULTIVATE_MEDIC = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(170, 1120), "Infirmary", None)
CULTIVATE_MEDIC_SUMMER = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(260, 1120), "Infirmary - Summer Camp", None)
...
CULTIVATE_GOAL_RACE_INTER_1 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(508, 1081), "Enter Career Race Details", None)
...
BEFORE_RACE_CHANGE_TACTIC = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(575, 745), "Pre-Race - Change Tactics", None)
...
BEFORE_RACE_CHANGE_TACTIC_3 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(435, 780), "Change Tactics - Stalker", None)
BEFORE_RACE_CHANGE_TACTIC_2 = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(285, 780), "Change Tactics - Mid-Pack", None)
...
BEFORE_RACE_START = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(465, 1175), "Pre-Race - Start Race", None)
BEFORE_RACE_SKIP = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(255, 1175), "Pre-Race - Skip Race", None)
...
IN_RACE_SKIP = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(560,1225), "In Race - Skip", None)
...
TRAINING_SELECT_WILL = ClickPoint(ClickPointType.CLICK_POINT_TYPE_COORDINATE, None, Coordinate(490, 1085), "Training - Willpower", None)
